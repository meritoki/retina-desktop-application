 ...
 */
package org.retina.view.dialog.output;
...
import org.retina.model.zooniverse.Project;
import org.retina.model.zooniverse.Workflow;
...
public class Zooniverse extends javax.swing.JDialog {
    ...
    public void initComboBox() {
        org.retina.model.zooniverse.Zooniverse zooniverse = (this.model != null) ? this.model.getZooniverse() : null;
        List<org.retina.model.zooniverse.Project> projectList = (zooniverse != null) ? zooniverse.getProjectList() : null;
        this.initProjectComboBox(projectList);
        this.initSearchProjectComboBox(new ArrayList<org.retina.model.zooniverse.Project>());
        this.initProjectWorkflowComboBox(new ArrayList<org.retina.model.zooniverse.Workflow>());
    }

    public void initProjectComboBox(List<org.retina.model.zooniverse.Project> projectList) {
    ...
    public void initSearchProjectComboBox(List<org.retina.model.zooniverse.Project> projectList) {
        String[] array = new String[0];
        if (projectList != null && projectList.size()>0) {
            array = new String[projectList.size()];
            for (int i = 0; i < array.length; i++) {
    ...
    public void initProjectWorkflowComboBox(List<org.retina.model.zooniverse.Workflow> workflowList) {
        String[] array = new String[0];
    ...
    private void addNewProjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addNewProjectActionPerformed
        ...
        org.retina.model.zooniverse.Zooniverse zooniverse = (this.model != null) ? this.model.zooniverse : null;
        if (zooniverse != null) {
