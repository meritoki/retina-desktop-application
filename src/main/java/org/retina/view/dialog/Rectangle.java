...
public class Rectangle extends javax.swing.JDialog implements MouseListener,KeyListener {
    ...
    List<String> timeList = Arrays.asList("year", "month", "week","day","hour","minute","second");
    List<String> spaceList = Arrays.asList("latitude","longitude","locale","location");
    List<String> energyList = Arrays.asList("letter","word","sentance","temperature","pressure");
    ...
    public void setModel(Model model){
        logger.debug("RectangleDialog.setModel("+model+")");
        this.model = model;
        this.init();
    }
    ...
    public void initList(){
        ...
        org.retina.model.Data data = (rectangle != null)?rectangle.data:null;
        List<org.retina.model.Text> textList = (data != null)?data.getTextList():null;
        this.initRectangleList(rectangleList);
    ...
    public void initTextValueComboBox(List<org.retina.model.Text> textList){
    ...
    public void initRectangleList(List<org.retina.model.Rectangle> rectangleList) {
        if(rectangleList!=null&&rectangleList.size()>0)
            logger.info("initRectangleList("+rectangleList+")");
        DefaultListModel defaultListModel = new DefaultListModel();
        if(rectangleList != null){
            for(int i=0;i<rectangleList.size(); i++) {
                defaultListModel.addElement(rectangleList.get(i).uuid);    
            }
        }
    ...
    private void applyUnitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyUnitButtonActionPerformed
        ...
        if(data != null){
            ...
            switch(unitType){
                case "Data":{
                    data.unit.type = org.retina.model.Unit.DATA;
                    break;
                }
                case "Time":{
                    data.unit.type = org.retina.model.Unit.TIME;
                    break;
                }
                case "Space":{
                    data.unit.type = org.retina.model.Unit.SPACE;
                    break;
                }
                case "Energy":{
                    data.unit.type = org.retina.model.Unit.ENERGY;
                    break;
                }
            }
